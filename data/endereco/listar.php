...
/*
Este cabeçalho permite o acesso a listagem de endereco
...
/*
Vamos definir qual será o formato de dados que o endereco
...
Utilizado. Vale lembrar que esta classe possui o CRUD para o endereco.
*/
...
Isso fará com que todos as funçôes que estão da classe endereco sejam
tranferidas para o objeto $endereco.
...
consulta no formato sql que seleciona todos os endereco("Select * from endereco")
*/
...
if($stmt->rowCount() > 0){
    ...
    criado com array com o nome de saida e assim guardar todos enderecos.
    */
    ...
    /*
    A estrutura while(enquando) realizar a busca e todos os enderecos
    ...
    */
    while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        */
        ...
        array. Assim estamos adicionando ao enderecos_arr[saída] um item
    ...
    */
    ...
    caso não hoje enderecos cadastrados no banco. Junto ao status code será exibido
    a mensagem "mensagem: Não há enderecos cadastrados" que será mostrando por meio
